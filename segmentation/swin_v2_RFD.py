...
class PatchEmbed(BaseModule):
    def __init__(self,
        ...
        self.projection = SRFD(in_channels, embed_dims)
...
class PatchMerging(BaseModule):
    def __init__(self,
        ...
        self.DRFD = DRFD(in_channels, out_channels)
...
class WindowMSA(BaseModule):
    ...
    def forward(self, x, mask=None):
        ...
        logit_scale = torch.clamp(self.logit_scale,
                                  max=torch.log(torch.tensor(1. / 0.01, device=self.logit_scale.get_device()))).exp()
